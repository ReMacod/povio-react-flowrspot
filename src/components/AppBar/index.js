...
export default function AppBar() {
  ...
  const { root, appBar, fablink, fabButton } = classes
    ...
    <div className={root}>
      <MuiAppBar position="static" className={appBar}>
        <Toolbar>
          ...
          <ButtonLink classes={buttonLinkClasses} label="Latest Sightings" linkTo="/" />
          <ButtonLink classes={buttonLinkClasses} label="Favorites" linkTo="/" />
